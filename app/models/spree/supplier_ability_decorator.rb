    ...
    def initialize(user)
      ...
      if user.supplier
        ...
        can [:modify], Spree::Classification do |classification|
         ...
         can [:modify, :create], Spree::OptionType do |option|
      ...
      #  can [:admin, :manage], Spree::OptionType do |option_type|
      #    option_type.supplier_ids.include?(user.supplier_id)
       # end
       # can [:admin,:create,:index], Spree::OptionType
